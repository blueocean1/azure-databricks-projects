...
class SetupHelper():
    ...
    def create_db(self):
        ...
        print(f"Creating a database {self.catalog}.{self.db_name} ...", end='')
    ...
    def create_registered_users_bz(self):
        if(self.initialized):
            ...
            raise ReferenceError("Application database is not defined. Cannot create a table in default database.")
